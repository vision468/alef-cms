...
export interface ApiOrderDetaileOrderDetaile extends Schema.CollectionType {
  collectionName: 'order_detailes';
  info: {
    singularName: 'order-detaile';
    pluralName: 'order-detailes';
    displayName: 'orderDetaile';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    order: Attribute.Relation<
      'api::order-detaile.order-detaile',
      'oneToOne',
      'api::order.order'
    >;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    catergory: Attribute.Relation<
      ...
      'api::catergory.catergory'
    >;
    sex: Attribute.Relation<'api::product.product', 'oneToOne', 'api::sex.sex'>;
    sku: Attribute.Integer;
    live: Attribute.Boolean;
    unlimited: Attribute.Boolean;
...
export interface ApiProductOptionProductOption extends Schema.CollectionType {
  ...
  attributes: {
    PriceIncrement: Attribute.BigInteger;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::order-detaile.order-detaile': ApiOrderDetaileOrderDetaile;
